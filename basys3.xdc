...
## Switches
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports {second_switches[0]}]
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports {second_switches[1]}]
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports {second_switches[2]}]
set_property -dict { PACKAGE_PIN W17   IOSTANDARD LVCMOS33 } [get_ports {second_switches[3]}]
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33 } [get_ports {second_switches[4]}]
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports {second_switches[5]}]
...
set_property -dict { PACKAGE_PIN T1    IOSTANDARD LVCMOS33 } [get_ports {reset_switch}]
set_property -dict { PACKAGE_PIN R2    IOSTANDARD LVCMOS33 } [get_ports {speed_up_switch}]
...
##Buttons
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports pause_button]
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports min_inc_button]
set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports hour_dec_button]
set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports hour_inc_button]
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports min_dec_button]
